...
* Anna Lembke - Associate Professor - Stanford
  ...
  * invisible forces/incentives to promote SUDs
    * opioid prescription incentivization - i mean look at the whole goddamn 2000s and how the opioid epidemic exasperated
  ...
  * sleep study reimbursements tanked
    * Health Plan of San Mateo (Medicaid) created a bundled payment model for this
      * funds the study, and then allows the patients to also get CPAP machines and treatment
        * uses the money made from selling CPAPs, and treatments and fittings, to fund the studies
...
* Akeel Williams - Senior Director, Corporate Strategies, Gilead Sciences
  * new focus on immunology and virology
* Courtney McCormick - Staff Scientist, Illumina
* Agustin Lopez Marquez - VP of Product, nference
  * yup, clinical data is messy, accept it as it is, even coding can't fix it.
  * images are tight, ex. ECGs
    * hidden features - trends/patterns that people can't see
      * ie. gender based on a scan of the back of the eye
* Jennifer Cozzone - Global Personalized Healthcare Strategy, Genentech
  * Pharma companies may be good intentioned, but the public perception of us pushing PHC means we have to hold ourselves to a much higher standard than others